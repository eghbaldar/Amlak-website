...
Module Module1
    ...
    Public Function CalculateDimensions(ByVal oldSize As Size, ByVal targetSize As Integer) As Size
        Dim newSize As Size
    ...
    Public Function ResizeImageFile(ByVal OldFile As String, ByVal NewFile As String, ByVal targetSize As Integer) As Boolean
        '----------------------------------------------------
    ...
    Public Function ResizeImageFile(ByVal OldFile As String, ByVal NewFile As String, ByVal Width As Integer, ByVal Height As Integer) As Boolean
        '----------------------------------------------------
        Dim f As IO.FileInfo = New IO.FileInfo(OldFile)
        Dim Buffer() As Byte = New Byte((f.OpenRead.Length) - 1) {}
        f.OpenRead.Read(Buffer, 0, CType(f.OpenRead.Length, Integer))
