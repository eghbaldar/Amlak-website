...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Username"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Username" DataNavigateUrlFormatString="MelkByUser.aspx?us={0}"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AmlakConnectionString %>"
        DeleteCommand="DELETE FROM [tblUser] WHERE [Username] = @Username" InsertCommand="INSERT INTO [tblUser] ([Username], [Name], [Family], [AddressEmail], [Namayandeh], [OzviatDate], [Active]) VALUES (@Username, @Name, @Family, @AddressEmail, @Namayandeh, @OzviatDate, @Active)"
        SelectCommand="SELECT [Username], [Name], [Family], [AddressEmail], [Namayandeh], [OzviatDate], [Active] FROM [tblUser] ORDER BY [OzviatDate] DESC"
