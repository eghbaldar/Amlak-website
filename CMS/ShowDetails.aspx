...
<script runat="server">
    ...
    Private Sub WriteData()
        ...
        Select Case MelkID
            ...
            Case 2
                ...
                lblKhab_2.Text = ObjDataRow("Tedad_Khab").ToString
    ...
    Private Sub GetImages()
        ...
        Try
            ...
            While dr.Read
                ImagesName1(Count) = dr("LittlePic").ToString.Replace("\", "/")
                ImagesName2(Count) = dr("OrginalPic").ToString.Replace("\", "/")
...
<!--====================================================================================-->        
    ...
    <br />
    <asp:Button ID="Button1" runat="server" PostBackUrl="~/CMS/AmlakList.aspx" Text="بازگشت به لیست" /><br />
</asp:Content>