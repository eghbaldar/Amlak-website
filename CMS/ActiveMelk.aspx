...
<script runat="server">
    ...
    Protected Sub btnActive_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim cmdText As String = "UPDATE tblMelk SET Visable=1 WHERE ID=" + Request("ID")
...
<!--====================================================================================-->        
    ...
    <hr />
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblStatus" runat="server" Font-Bold="True" ForeColor="#FF0000"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>
    ...
    <div style="text-align: center">
        ...
        <table  style="width: 40%">
            <tr>
                <td>
                    <asp:Button ID="btnActive" runat="server" Text="فعال سازی" Width="90px" OnClick="btnActive_Click"/>
                </td>
                <td>
                    <asp:Button ID="Button1" runat="server" PostBackUrl="~/CMS/AmlakList.aspx" Text="بازگشت به لیست" Width="90px" /></td>
            </tr>
        </table>
    </div>
    <br />
