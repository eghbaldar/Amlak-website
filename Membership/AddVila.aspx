...
<script runat="server">
    ...
    Protected Sub Wizard1_NextButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.WizardNavigationEventArgs)
        lblTozihat.Text = "استان " + ddlOstan.SelectedItem.Text + " - " + "شهر " + ddlShahr.SelectedItem.Text + " - " + ddlMoameleh.SelectedItem.Text + " ویلا"
    ...
    Private Sub SaveItems(ByVal ItemType As Byte)
        ...
        Select Case ItemType
            Case 0
                ...
                Result = Vila.Insert_Vila_Foroosh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
            ...
            Case 1
                Result = Vila.Insert_Vila_RahnEjareh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
            ...
            Case 2
                Result = Vila.Insert_Vila_Rahn(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
            ...
            Case 3
                Result = Vila.Insert_Vila_Ejareh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
