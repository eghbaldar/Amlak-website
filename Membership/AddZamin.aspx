...
<script runat="server">
    ...
    Protected Sub Wizard1_NextButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.WizardNavigationEventArgs)
        lblTozihat.Text = "استان " + ddlOstan.SelectedItem.Text + " - " + "شهر " + ddlShahr.SelectedItem.Text + " - " + ddlMoameleh.SelectedItem.Text + " زمین"
    ...
    Private Sub SaveItems(ByVal ItemType As Byte)
        ...
        Select Case ItemType
            Case 0
                Result = Zamin.Insert_Zamin_Foroosh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
                                                    ...
                                                    txtzirBana.Text.Trim, txtToolBar.Text.Trim, txtTozihat2.Text.Trim, "", ddlMalekiat.SelectedIndex)
