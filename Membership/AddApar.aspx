...
<script runat="server">
    ...
    Private Sub SaveItems(ByVal ItemType As Byte)
        ...
        Select Case ItemType
            Case 0
                Result = Apar.Insert_Aparteman_Foroosh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
                                                       ...
                                                       Int(ddlNama.SelectedItem.Value), ddlSokunat.SelectedIndex, _
                                                       txtTabagheh.Text.Trim, txtVahed.Text.Trim, txtKhab.Text.Trim, txtVahedForoosh.Text.Trim, _
                                                       txtMofid.Text.Trim, txtMosha.Text.Trim, txtKol.Text.Trim, ddlKarbari.SelectedIndex, ddlMalekiat.SelectedIndex, ddlWC.SelectedIndex, _
                                                       EmkanatList.Items(0).Selected, EmkanatList.Items(1).Selected, EmkanatList.Items(2).Selected, EmkanatList.Items(3).Selected, _
                                                       EmkanatList.Items(4).Selected, EmkanatList.Items(5).Selected, EmkanatList.Items(6).Selected, EmkanatList.Items(7).Selected, _
                                                       EmkanatList.Items(8).Selected, EmkanatList.Items(9).Selected, EmkanatList.Items(10).Selected, EmkanatList.Items(11).Selected, _
                                                       EmkanatList.Items(12).Selected, txtTozihat2.Text.Trim, "")
                                                     
            Case 1
                Result = Apar.Insert_Aparteman_RahnEjareh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
            ...
            Case 2
                Result = Apar.Insert_Aparteman_Rahn(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
            ...
            Case 3
                Result = Apar.Insert_Aparteman_Ejareh(Session("UserName").ToString(), 1, Int(ddlOstan.SelectedItem.Value), Int(ddlShahr.SelectedItem.Value), 1, _
                                                      txtTel1.Text.Trim, txtTel2.Text.Trim, txtAddress.Text.Trim, txtEjareh2.Text.Trim, txtTozihat1.Text.Trim, _
                                                      Int(ddlNama.SelectedItem.Value), ddlSokunat.SelectedIndex, _
                                                      txtTabagheh.Text.Trim, txtVahed.Text.Trim, txtKhab.Text.Trim, txtVahedForoosh.Text.Trim, _
                                                      txtMofid.Text.Trim, txtMosha.Text.Trim, txtKol.Text.Trim, ddlKarbari.SelectedIndex, ddlMalekiat.SelectedIndex, ddlWC.SelectedIndex, _
                                                      EmkanatList.Items(0).Selected, EmkanatList.Items(1).Selected, EmkanatList.Items(2).Selected, EmkanatList.Items(3).Selected, _
    ...
    Protected Sub Wizard1_NextButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.WizardNavigationEventArgs)
        lblTozihat.Text = "استان " + ddlOstan.SelectedItem.Text + " - " + "شهر " + ddlShahr.SelectedItem.Text + " - " + ddlMoameleh.SelectedItem.Text + " آپارتمان"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: right">
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="False" Height="344px" Width="592px" ActiveStepIndex="0" StartNextButtonText="مرحله بعد" StepNextButtonText="مرحله بعد" FinishCompleteButtonText="پایان" FinishPreviousButtonText="مرحله قبل" OnFinishButtonClick="Wizard1_FinishButtonClick" StepPreviousButtonText="مرحله قبل" OnNextButtonClick="Wizard1_NextButtonClick">
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td style="width:60px;">
                                <span style="color: #0000cc">متراژ</span>
                            </td>
                            <td>
                                مفید :
                            </td>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <br />
                                <center>
                                    <asp:Button ID="Button1" runat="server" PostBackUrl="~/Membership/Default.aspx" Text="بازگشت به صفحه اصلی" />
                                </center>
                            </td>
                        </tr>
                    </table>
